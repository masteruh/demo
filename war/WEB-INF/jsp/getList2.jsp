...
<%@ page import="beans.*"%>
<% List<Cuenta> personas = (List<Cuenta>)request.getAttribute("personas");%>
...
<div class="clear"></div>
<ul id="nav_list">
<li class="li_nav_body"><a href="WEB-INF/inicio.jsp">Inicio</a></li>
<li class="li_nav_body"><a href="WEB-INF/Login.jsp">Login</a></li>	
<li class="li_nav_body"><a href="Registrarse.jsp">Registrarse</a></li>
...
<li class="li_nav_footer"><a href="mapaSitio.jsp">Mapa de Sitio</a></li>
</ul>
<div class="clear"></div>
</div>
...
</p><p style="color:#FFFFFF; text-align:left">Colegio San Miguel Arcangel - Jose Galvez 912-914 Miraflores- Arequipa , Teléfono: 051-054 202020 Fax: 051-054 23624  </p>
<p style="color:#FFFFFF; text-align:left">Arequipa-Perú | 2017 </p>
</div>
<br></br><br></br>
