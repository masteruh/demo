...
<div class="wrap">
   ...
   <div class="container">
      ...
      <aside>
         <h3>Categorias</h3>
         <ul class="categories">
            <li><span><a href="/horarios">Horarios</a></span></li>
          ...
          <li><span><a href="/verCambios">ultimos cambios de contraseña</a></span></li>
          <li><span><a href="/subirArchivos">Subir Archivos</a></span></li>     
         </ul>
      ...
      <section id="content">
         ...
         <div class="inside">
            ...
            <h2>Bienvenida secretaria <%=misesion.getAttribute("nombre") %></h2>
