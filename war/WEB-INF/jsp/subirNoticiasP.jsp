   ...
   <div class="container">
      ...
      <aside>
         ...
         <ul class="categories">
            ...
            <li><span><a href="/subirNoticiasP">Publicar Noticias</a></span></li>           
      ...
      <section id="content">
         ...
         <div class="inside">
            ...
            <form action="/publicarP" method="get">
    <center>
    <h3>Publicacion de Noticias Escolares</h3>
    <br>
   
    <br>
    <label>Nombre del autor :</label>
    <input type='text' name='autor' value=<%=misesion.getAttribute("nombre") %> readonly>
     <br><br>
     <label>Asunto :</label>
    ...
    <br><br>
     <h3>Ponga usted los comentarios de la noticia </h3>
    <TEXTAREA NAME="datos" ROWS="10" COLS="50"  ALIGN="alineamiento"
    WRAP="off | soft | hard">
    
   Colegio San Miguel Arcangel. </TEXTAREA>
