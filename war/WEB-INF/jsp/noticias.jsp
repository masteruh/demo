      ...
      <div class="container">
         ...
         <nav>
            <ul>           
               ...
               <li class="current"><a href="/noticias" class="m3">Noticias</a></li>
...
<%for( Noticia p : noticias ) {%>
	<fieldset><legend><%= p.getAutor() %>  <%= p.getFecha() %></legend>
<%= p.getAsunto() %><br></br> 
<%= p.getDatos() %>
</fieldset>
<br></br>
