      ...
      <section id="content">
         <div id="banner">
             <h2>Colegio <span>San Miguel <span>Arcangel</span></span></h2>
				...
				<h3>Se ha registrado un nuevo alumno satisfactoriamente</h3>
				<div class="table">
	                    <table class="listing" cellpadding="0" cellspacing="0">
	                        ...
	                        <tr>
									...
									<td><p><%=alumno.getCorreo()%></p></td>									
									<td><p><%=alumno.getCuenta().getUsuario()%></p></td>
									<td><p><%=alumno.getCuenta().getContraseña()%></p></td>
	           ...
	           <div id="mod"><a href="/modificarContraAl" >modificar contraseña</a><br></div>            
