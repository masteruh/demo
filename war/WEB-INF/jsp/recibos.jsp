...
<% Pension pension=(Pension)request.getAttribute("pension"); %>
         ...
         <div class="inside">
            ...
            <div class="table">
                    <table class="listing" cellpadding="0" cellspacing="0">
                    	...
                    	<tr>
                            <th class="full" colspan="2"><h2>Colegio San Miguel Arcangel</h2> <br>Direccion: Av. Pedro Picapiedra 977<br><br>Teléfono: 051-054 202020 <br>Fax: 051-054 23624</th>
                        	<th><h2>BOLETA</h2><br>N° <%=r.getNumero()%></th>                   
                        </tr>
                    	
                    	<tr>
                            <td colspan="3">
                            Codigo: <%=r.getCodigo()%><br>
                            Nombre: <%=alumno.getNombre() %><br>
                            Apellido: <%=alumno.getApellido() %><br>
                            Grado: <%=alumno.getGrado()%><br>
                            Fecha: <%=fecha.getTime()%>                                                       
                            </td>                        	
                        ...
                        <tr>
							 <td><p><%=r.getConcepto()%></p></td>
							 <td><p></p></td>
							 <td><p><%=pension.getMonto()%></p></td>
							 
						</tr>
						<tr>
							 <td><p>A cuenta</p></td>
							 <td><p></p></td>
							 <td><p><%=(pension.getMonto()-pension.getSaldo())-r.getCancelado()%></p></td>							 
						</tr>
						<tr>
							 <td><p>Efectivo</p></td>
							 <td><p></p></td>
