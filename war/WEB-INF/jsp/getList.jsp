...
<% List<Alumno> personas = (List<Alumno>)request.getAttribute("personas");%>
         ...
         <div id="banner">
             <h2>Colegio <span>San Miguel <span>Arcangel</span></span></h2>
				...
				<form action="/remove" method="get">
					<h2>Eliminar alumno por 'codigo'</h2>
					<div id="formulario">
				  	Codigo del alumno:<br>
				...
				<br>
				<h2>Mostrando <%= personas.size() %> alumnos</h2>
				<div class="table">
	                    <table class="listing" cellpadding="0" cellspacing="0">
	                        ...
	                        <tr>
	                        		<td><p><%=p.getCodigo()%></p></td>
								    <td><p><%=p.getNombre() %></p></td>
									<td><p><%=p.getApellido() %></p></td>
									<td><p><%=p.getGrado() %></p></td>
									<td><p><%=p.getCorreo()%></p></td>									
									<td><p><%=p.getCuenta().getUsuario()%></p></td>
									<td><p><%=p.getCuenta().getContraseña()%></p></td>
									<td><p><%=p.getSeccion() %></p></td>
