...
<br>
Apellido:<br>
<input type="text" name="apell" placeholder="Apellido" required>
<br>
Correo electrónico:<br>
<input type="email" name="corr" placeholder="correo@email.com" required>
<br>
Grado:<br>
...
<input type="radio" name="SEC" value="A" required>A
<input type="radio" name="SEC" value="B" required>B
	   
  </select>
<br>
Sexo:<br>
<input type="radio" name="sex" value="male" required>Hombre

<input type="radio" name="sex" value="female" required>Mujer
<br>
Edad:<br>
...
<a style="color:blue">Verifique sus datos antes de guardar </a>
